...
# -*- coding: utf-8 -*-
#
# writing-sphinx documentation build configuration file, created by
# sphinx-quickstart on Mon Oct 19 02:01:06 2015.
#
...
htmlhelp_basename = 'writing-sphinxdoc'
...
latex_documents = [
  (master_doc, 'writing-sphinx.tex', 'writing-sphinx Documentation',
   'Author Name', 'manual'),
]
...
man_pages = [
    (master_doc, 'writing-sphinx', 'writing-sphinx Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'writing-sphinx', 'writing-sphinx Documentation',
   author, 'writing-sphinx', 'One line description of project.',
   'Miscellaneous'),
]
